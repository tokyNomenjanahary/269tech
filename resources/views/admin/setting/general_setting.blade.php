                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold"> @lang('Login and register Title') </label>
                                    <input class="form-control form-control-lg" type="text" name="login_title" value="{{$general->login_title}}">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold"> @lang('Login and register Sub Title') </label>
                                    <input class="form-control form-control-lg" type="text" name="login_sub_title" value="{{$general->login_title}}">
                                </div>
                            </div>
