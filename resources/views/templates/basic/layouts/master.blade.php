                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav main-menu m-auto">
                            <li class="menu_has_children">
                                <img class="user-img" src="{{ asset($activeTemplateTrue.'images/play/Ellipse_2.png') }}"
                                     alt="use"/>
                                <ul class="sub-menu">
                                    <li><a href="{{ route('user.home') }}">@lang('Dashboard')</a></li>
                                    <li class="menu_has_children" id="visible">
                                    ...
                                    <li class="menu_has_children" id="visible">
                                        <a href="#">@lang('Withdraw')<span class="caret"></span></a>
                                        <ul class="sub-menu" id="hidden">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 text-md-left text-center order-lg-1 order-2">
                        <p>@lang('All rights & Copy right reserved by') <span
                                class="base--color">GZERONE</span></p>
                    </div>
